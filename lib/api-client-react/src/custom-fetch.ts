...
/**
 * Register a getter that supplies a device ID string.
 * When set, an `X-Device-Id` header is attached to every request.
 */
...
export async function customFetch<T = unknown>(
  ...
  // Attach device ID header when a getter is configured.
